        ...
        <div className="flex items-center space-x-7">
          {isLoggedIn ? (
            <>
              ...
              >
                <svg className="mb-1.5 h-7 w-7" fill="none" stroke="currentColor" strokeWidth="2"
                     viewBox="0 0 24 24">
            ...
            <>
              {/* 비로그인 */}
              <Link href="/login" className="flex cursor-pointer flex-col items-center text-gray-600 hover:text-red-500">
                <svg className="mb-1.5 h-7 w-7" fill="none" stroke="currentColor"
