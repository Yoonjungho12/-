    ...
    <>
          ...
          {regions.map((region) => {
            ...
            return (
              <button
                ...
                className={`px-3 py-2 text-center rounded text-sm ${
                  isSelected
                    ? // 선택된 경우: 테두리X, bg-amber만
                      "bg-zinc-700 text-white"
                    : // 선택 안된 경우: 기본 테두리
                      "bg-white text-gray-700 border border-zinc-700"
                } hover:opacity-80`}
              >
                {region.name}
              </button>
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <input
          ...
          className="flex-1 border border-zinc-700 rounded px-2 py-1"
        />
      </div>
      <div className="flex flex-col sm:flex-row gap-2">
        <label className="w-32 font-semibold">
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <div className="flex flex-col sm:flex-row gap-2 flex-1">
          <select
            ...
            className="border border-zinc-700 rounded px-2 py-1 w-full sm:w-1/2 mb-2"
          >
          ...
          {holidaySelectVal === "직접입력" && (
            <input
              ...
              className="border border-zinc-700 rounded px-2 py-1 w-full sm:w-1/2"
            />
          )}
        </div>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className="w-full border border-zinc-700 rounded px-2 py-1"
        />
      </div>
...
이 곳에는 간단한 소개글을 적어주세요.
        ...
        <div className="flex items-center gap-4 flex-wrap">
          <div className="flex items-center gap-1">
            ...
            <select
              ...
              className="border border-zinc-700 rounded px-2 py-1"
            >
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-2 mb-2">
          <input
            ...
            className="border border-zinc-700 rounded px-2 py-1 flex-1"
          />
          <button
            type="button"
            onClick={handleAddressSearch}
            className="px-4 py-2 rounded bg-zinc-800 text-white font-semibold hover:bg-zinc-700"
          >
            검색하기
          </button>
        </div>
        <input
          ...
          className="border border-zinc-700 rounded px-2 py-1 w-full mb-2"
        />
        {/* 지도 */}
        {isMaster === false && (
      ...
      <div>
        ...
        <input
          ...
          className="w-full border border-zinc-700 rounded px-2 py-1 mb-2"
        />
      </div>
    </>
  );
