 ...
 */
export default function StoreInfoEditor({ storeInfo, setStoreInfo, sections, setSections, formatPrice, onlyDigits }) {
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                onChange={(e) => setTempInfo(prev => ({ ...prev, greeting: e.target.value }))}
                rows={3}
                disabled={!isEditing}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-50 disabled:text-gray-500 resize-none"
              />
            </div>
            <div>
              ...
              <textarea
                ...
                onChange={(e) => setTempInfo(prev => ({ ...prev, event_info: e.target.value }))}
                rows={3}
                disabled={!isEditing}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-50 disabled:text-gray-500 resize-none"
              />
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1 ma">프로그램 정보</label>
              <textarea
