...
export default function NewListingPage() {
  ...
  // 폼 입력값 상태
  // -------------------------------------
  const [adType, setAdType] = useState(''); // "VIP" 또는 "VIP+"
  ...
  function handleAddressSearch() {
    ...
    geocoder.addressSearch(addressInput, (result, status) => {
      if (status === kakao.maps.services.Status.OK) {
        ...
        alert('주소를 찾을 수 없어요. 정확한 주소를 입력해 주세요.');
      }
    });
  }
  ...
  // -------------------------------------
  // 폼 전송: 백엔드 API (api/partnership)로 데이터 전송
  // -------------------------------------
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 items-center">
          ...
          <div className="flex gap-3">
            <button
              ...
              className={`px-6 py-2 rounded border ${adType === 'VIP' ? 'bg-red-500 text-white border-red-500' : 'bg-white text-gray-700 border-gray-300'} hover:opacity-80`}
            >
              VIP
            </button>
            <button
            ...
            {regions.map((region) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-2 text-center rounded border border-gray-300 ${isSelected ? 'bg-red-500 text-white border-red-500' : 'bg-white text-gray-700'} hover:opacity-80`}
                >
                  {region.name}
                </button>
              );
        ...
        {/* 연락방법 */}
        <div className="flex flex-col sm:flex-row gap-2">
          <label className="w-32 font-semibold">연락방법</label>
          <input
            type="text"
            placeholder="전화/문자/예약 모두 가능합니다."
            value={contactMethod}
        ...
        {/* 인사말 */}
        <div>
          <label className="block font-semibold mb-1">인사말</label>
          <textarea
        ...
        {/* 이벤트 */}
        <div>
          <label className="block font-semibold mb-1">이벤트</label>
          <textarea
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="인근 지하철 및 주요 건물 (예: 성수역 2번출구 도보 3분)"
            value={nearBuilding}
        ...
        <div>
          ...
          <textarea
            placeholder="예) 11:00 ~ 04:00 / 24시간 가능 / 휴무일 등"
            value={openHours}
        ...
        <div>
          ...
          <textarea
            placeholder="예) A코스 스웨디시 60분 11만 → 9만"
            value={programInfo}
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="예) [지역/업소명] 프리미엄 스웨디시 전문"
            value={postTitle}
        ...
        <div>
          ...
          <textarea
            placeholder="예) 보나(23) 주간, 빛나(32) 중간, 안나(22) 야간 등 상세 스펙"
            value={managerDesc}
